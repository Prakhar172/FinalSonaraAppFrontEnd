...
public class addcustomer extends AppCompatActivity {
    ...
    RadioGroup add_costmer_radio_group;
    RadioButton new_lap, old_lap;
    String radio_res = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new_lap = findViewById(R.id.add_customer_radio_newLap);
        old_lap = findViewById(R.id.add_customer_radio_oldLap);
        ...
        add_costmer_radio_group = findViewById(R.id.add_customer_radio_group);
        btn_add_customer = findViewById(R.id.btn_add_customer);

        if (add_costmer_radio_group.getCheckedRadioButtonId() == new_lap.getId()) {
            radio_res = "New Laptop";
        } else {
            radio_res = "Old Laptop";
        }
