...
public class EmployeeProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_add_customer = findViewById(R.id.btn_employee_profile_add_customer);
        btn_show_customer = findViewById(R.id.btn_employee_profile_show_customer);
        btn_Complaints = findViewById(R.id.btn_emplyoe_complaint);
        btn_logout = findViewById(R.id.btn_employee_profle_logout);
