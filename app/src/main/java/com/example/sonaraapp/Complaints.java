...
public class Complaints extends AppCompatActivity {
    ...
    Button addcomplaint, passby, confirmed;
    RadioGroup radio_complaint;
    String status;
    String id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedData sharedData = new SharedData(Complaints.this);
        id = sharedData.GetId();
        ...
        passby = findViewById(R.id.radio_btn_passby);
        radio_complaint = findViewById(R.id.complaint_radio);
        confirmed = findViewById(R.id.radio_btn_accepted);
        addcomplaint = findViewById(R.id.btn_add_complaint);
        final String radio_res = "";

        if (radio_complaint.getCheckedRadioButtonId() == findViewById(R.id.radio_btn_passby).getId()) {
            status = "PENDING";
        } else {
            status = "PROCESS";
        }
        ...
        addcomplaint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (et_complaint_name.getText().toString().isEmpty()) {
                    ...
                    addcomplaint(et_complaint_name.getText().toString(), et_complaint_mobno.getText().toString(), et_complaint_modelno.getText().toString(), et_complaint_problem.getText().toString(), et_complaint_estimate.getText().toString(), et_complaint_paid.getText().toString(), status);
                }
            }
        });
    }

    private void addcomplaint(final String name, final String mobile, final String modelno, final String problem, final String estimate, final String paid, final String status) {
